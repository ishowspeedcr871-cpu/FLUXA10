      ...
      <div className="space-y-8 pb-24">
        ...
        <div className="bg-black/40 border border-white/10 rounded-[32px] p-8 backdrop-blur-md space-y-6">
          ...
          <form action={updateOrganizationSettingsAction} className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-4">Currency Code</label>
              <Input name="currency" defaultValue={organization.settings?.currency ?? "INR"} className="bg-white/5 border-white/10 rounded-2xl h-12" />
            </div>
