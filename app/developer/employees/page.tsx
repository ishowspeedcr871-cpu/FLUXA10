...
export default async function Page({
  ...
  const data = await listPlatformUsers(await searchParams, "ORGANIZATION");
  return (
    <DeveloperPortalLayout>
      <section className="grid gap-6">
        <Card>
          <CardHeader>
            <CardTitle>Global employees</CardTitle>
            <CardDescription>
              Organization staff and operator accounts across tenants.
            </CardDescription>
          </CardHeader>
          <CardContent>
